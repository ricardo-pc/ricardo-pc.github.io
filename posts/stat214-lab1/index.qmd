...
date: "2026-03-01"
categories: [Python, Machine Learning, Statistical Computing, Bayesian Inference]
---

::: {.callout-note appearance="simple" icon=false}
## Project Overview

A full analysis of the PECARN pediatric head trauma dataset, from data cleaning and exploratory analysis to Bayesian inference and classification modeling, centered on the question of when to recommend a CT scan for a child with a head injury.
...
- [GitHub Repository](https://github.com/berkeley-stat214/stat-214/tree/main/lab1) — full code, notebooks, and report
- [Lab Report (PDF)](report.pdf) — complete write-up with all figures and tables
