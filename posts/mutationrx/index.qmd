...
description: "A resistance-aware drug-repurposing tool that combines docking, uncertainty estimates, and grounded mechanistic review to help researchers decide which computational hits are worth testing."
...
> **Docking proposes candidates. Grounded review helps researchers decide what to test.**
...
Then a **grounded Claude review checks each hit for mechanistic plausibility** and shows its evidence to the researcher. A beta-blocker that "binds" EGFR is almost certainly an artifact, while a drug whose real mechanism fits the target may be worth an assay. Remove that review and the interface falls back to an untrustworthy hit list; keep it visible and the researcher still owns the decision.
