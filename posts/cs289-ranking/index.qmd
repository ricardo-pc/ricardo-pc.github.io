...
date: "2026-05-27"
categories: [Machine Learning, Deep Learning, Recommender Systems]
image: sparsity_results.png
---
...
**[▶ Explore the interactive version](https://ricardo-pc.github.io/cs289-ranking/)**: play recommender against the real trained model, starve a user's data with the density slider, flip between the two metrics that tell different stories, and get movie recommendations computed live in your browser.
...
![Item popularity follows a steep power law. The top 20% of movies account for roughly two-thirds of all ratings — it takes the top third of the catalog to reach 80% — leaving the long tail nearly invisible to any model trained on this data.](eda_item_popularity.png){width=90%}
...
- [Interactive walkthrough](https://ricardo-pc.github.io/cs289-ranking/): the full study as an interactive site — guess what real users watched next, place your bet on the outcome before the reveal, explore the embedding map of all 3,706 movies, and rate a few films to get recommendations from the actual trained model, running entirely in your browser
